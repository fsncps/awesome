...
theme.dir = home .. "/.config/awesome/vendor/theme"

-- Basic appearance
theme.font = "FiraCode Nerd Font 10"
theme.taglist_font = "FiraCode Nerd Font ExtraLight 12.5"
theme.clock_font = "FiraCode Nerd Font ExtraLight 15.5"
...
theme.useless_gap = 0
theme.icon_theme = os.getenv("HOME") .. "/.local/share/icons/Gruvbox/"
theme.titlebar_height = 60
...
function theme.at_screen_connect(s)
  ...
  --markuplocal wallpaper = require("wallpaper")
  --wallpaper.init()
  ...
  s.mytasklist = awful.widget.tasklist({
    ...
    widget_template = {
      ...
      create_callback = function(self, c)
        local text_w = self:get_children_by_id("task_name")[1]
        if text_w then
          local name = c.name or "<untitled>"
          if #name > 35 then
            name = name:sub(1, 30) .. " ..."
          end
          text_w:set_text(name)
        end
      end,
